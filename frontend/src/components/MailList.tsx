...
// [FIX 1] import { zhCN } ko hata diya gaya hai. Ab date-fns browser ki default language use karega.
...
                  addSuffix: true,
                  // [FIX 2] locale: zhCN, ko hata diya gaya hai. Ab date-fns browser ki default language use karega.
                })}
              </div>
            </div>
...
              {/* [FIX 3] Hardcoded Chinese text ko t() function se replace kiya gaya hai */}
              {t("Return to mail list")}
            </button>
          )}
        </div>
